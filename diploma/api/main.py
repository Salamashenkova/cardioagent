...
class AppService:
    ...
    def _add_memory_message(self, role: str, text: str):
        self.chat_memory.append({"role": role, "text": text, "ts": datetime.datetime.now().isoformat()})
    ...
    async def chat_with_assistant(self, message: str, diagnosis: str, confidence: float, clinical_info: str, previous_rag_context: Dict = None) -> Dict[str, Any]:
        try:
